...
* Run <code>rake</code> to test the connection of your Leap (it will output simple info about each frame, and demonstrates how to listen for Leap events):
